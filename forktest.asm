...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    10a1:	48 be 48 16 00 00 00 	movabs $0x1648,%rsi
    10a8:	00 00 00 
  ...
  if(n == N){
    ...
    110f:	48 be 58 16 00 00 00 	movabs $0x1658,%rsi
    1116:	00 00 00 
  ...
  for(; n > 0; n--){
    ...
    114b:	48 be 77 16 00 00 00 	movabs $0x1677,%rsi
    1152:	00 00 00 
  ...
  if(wait() != -1){
    ...
    1192:	48 be 8b 16 00 00 00 	movabs $0x168b,%rsi
    1199:	00 00 00 
  ...
  printf(1, "fork test OK\n");
    11be:	48 be 9e 16 00 00 00 	movabs $0x169e,%rsi
    11c5:	00 00 00 
